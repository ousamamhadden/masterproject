...
def train():
    ...
    lora_config = LoraConfig(r=R,lora_alpha=LORA_ALPHA,lora_dropout=LORA_DROPOUT,task_type=TaskType.SEQ_CLS,target_modules='all-linear')
    ...
    lora_model.save_pretrained('fine-tuned-model-full-data-1-epoch')
