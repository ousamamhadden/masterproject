...
filter_size = 9     # Should be uneven
...
for epoch in range(num_epochs):
    ...
    torch.save(model.state_dict(), os.path.join(models_dir, f"cnn_classlabels_large_filter_e{epoch+1}_d{dt_string}_s{len(train_dataset)}"))
